...
def execute_robot_bid(room_data: Dict, robot_seat: str) -> str:
    """
    Execute an intelligent robot bid using the Fantoni-Nunes system
    ...
    """
    try:
        from .robot_bidder import RobotBidder
        robot_bidder = RobotBidder()
        return robot_bidder.make_bid(room_data, robot_seat)
    except Exception as e:
        print(f"Robot bidding error: {e}")
        # Fallback to pass if intelligent bidding fails
        return 'pass'
