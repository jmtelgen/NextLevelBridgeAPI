...
RUNTIME="python3.12"
ROLE_ARN="arn:aws:iam::851725597758:role/lambda-execution-role"  # Update this
TIMEOUT=30
MEMORY_SIZE=256
...
echo ""
echo "Next steps:"
echo "1. Configure API Gateway to route to this Lambda"
